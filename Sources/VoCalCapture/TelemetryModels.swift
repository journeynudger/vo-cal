...
public struct CaptureTelemetrySnapshot: Equatable, Sendable {
    public var started: Bool
    public var deviceID: String?
    public var outboxPath: String?
    public var relayBaseURL: String?
    ...
    public var declaredCount: Int
    public var uploadingCount: Int
    public var pendingCloudCount: Int
    ...
    public var oldestPendingCreatedAt: Date?
    public var lastSuccessfulUploadAt: Date?
    public var recentCaptures: [LocalCaptureRecord]
    public var relayReachable: Bool
    public var inFlight: Bool
    public var lastSyncAt: Date?
    public var lastReason: String?
    public var lastError: String?
    public var latestRemoteSequence: Int64?
    public var remoteCaptureCount: Int
    ...
    public init(
        ...
        oldestPendingCreatedAt: Date?,
        lastSuccessfulUploadAt: Date?,
        recentCaptures: [LocalCaptureRecord],
        relayReachable: Bool,
        inFlight: Bool,
        lastSyncAt: Date?,
        lastReason: String?,
        lastError: String?,
        latestRemoteSequence: Int64?,
        remoteCaptureCount: Int
    ) {
        self.started = started
        self.deviceID = deviceID
        self.outboxPath = outboxPath
        ...
        self.declaredCount = declaredCount
        self.uploadingCount = uploadingCount
        self.pendingCloudCount = pendingCloudCount
        ...
        self.lastReason = lastReason
        self.lastError = lastError
        self.latestRemoteSequence = latestRemoteSequence
        self.remoteCaptureCount = remoteCaptureCount
    }

    public static let initial = CaptureTelemetrySnapshot(
        started: false,
        deviceID: nil,
        outboxPath: nil,
        relayBaseURL: nil,
